"""Hook manager for discovering, loading, and executing hooks.

This module provides the HookManager class which handles:
- Hook discovery from the hooks directory
- Loading Python module hooks and executable hooks
- Hook configuration via hooks.yaml
- Event emission to subscribed hooks
