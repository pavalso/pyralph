...
.. note::
   ...
   When a ``CHANGELOG.md`` file exists at the repository root, its content
   will be automatically included here. Until then, this template serves as
   a guide for maintaining the changelog.
